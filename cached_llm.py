...
IMPORTANT: You have access to live market data in each question prompt. 
Always use this data as your primary anchor for any price or rate related 
forecasts. Never rely on training data for current prices."""
